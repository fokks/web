...
<table cols="2">
          ...
          <code class="hljs language-text" id="ajaxDiv" >
            <script>
                      $( document ).ready(function() {
                            codeLoad("<%=request.getContextPath()%>/sources/jsp-course/radiobutton.jsp",
                            $("#ajaxDiv"));
                        }); 
            </script>
          </code>
    ...
    <tr>
        <td></td>
        <td><button class="button-source"><a href="<%=request.getContextPath()%>/sources/jsp-course/radiobutton.jsp"  target="_blank">Показать в отдельной вкладке</a></button></td>
    </tr>
</table>
</body>
</html>
